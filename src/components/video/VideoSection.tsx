...
export function VideoSection({ videoId }: VideoSectionProps) {
	...
	return (
		<>
			<div className="span -mt-12 h-32 self-start bg-gradient-to-b from-transparent to-konf-background-blue" />
			<section id="video" className="w-full bg-konf-background-blue py-16 px-4">
